...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=$gpu_index python -m run.train \
  ...
  dataset.past_fold_path="[./fold/train_2019_with_fold_5.csv,./fold/train_2018_task_1_2_test_with_fold_5.csv,./fold/train_2018_task_1_2_validation_with_fold_5.csv,./fold/train_2018_task_3_test_with_fold_5.csv,./fold/train_2018_task_3_validation_with_fold_5.csv]" \
